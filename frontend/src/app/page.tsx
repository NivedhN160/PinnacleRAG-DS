  ...
  return (
    <main className="relative min-h-screen text-slate-50 overflow-hidden font-sans">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-20 text-center">
        ...
        {/* Glowing Badge */}
        <div className="mb-8 inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-500/30 bg-blue-500/10 backdrop-blur-md">
          <span className="w-2 h-2 rounded-full bg-blue-400 animate-pulse"></span>
          <span className="text-sm text-blue-200 font-medium tracking-wide uppercase">PinnacleRAG-DS v2.0</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
          {/* Trading Card */}
          <div className="group relative rounded-2xl border border-slate-700 bg-slate-800/40 backdrop-blur-sm p-8 hover:bg-slate-800/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/20 cursor-pointer overflow-hidden">
          ...
          {/* Security Card */}
          <div className="group relative rounded-2xl border border-slate-700 bg-slate-800/40 backdrop-blur-sm p-8 hover:bg-slate-800/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-red-500/20 cursor-pointer overflow-hidden">
          ...
          {/* SEO Card */}
          <div className="group relative rounded-2xl border border-slate-700 bg-slate-800/40 backdrop-blur-sm p-8 hover:bg-slate-800/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-500/20 cursor-pointer overflow-hidden">
